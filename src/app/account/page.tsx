...
const AccountPage = () => {
  const {
    user: { email, cart_items, first_name, last_name, orders, gender },
    isAuthenticated,
  } = useSelector(
    (state: IStoreState) => state.UserReducer
        ...
        <div className="flex flex-col w-[500px] px-8 py-6 rounded shadow bg-white mx-8">
          ...
          <div className="flex">
            ...
            <div className="flex flex-col mx-4">
              ...
              <form className="my-3 text-sm flex" action="" method="post">
                <div>
                  <input
                    type="radio"
                    name="gender"
          ...
          <button className="px-4 py-2 mt-8 text-sm rounded text-stone-100 bg-stone-900">
            Save
          </button>
        </div>
      </div>
